...
This package is being actively used by the crcspin model, which itself is not contained in the package. The user pool for this package is small and we have no plans of releasing it to CRAN at this time. If you would like to use it, get in touch.
